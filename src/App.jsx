  ...
  return (
    <PageTransition routeKey="home">
      <div id="top" className="min-h-screen bg-white text-gray-900">
        ...
        {/* Hero */}
        <section data-section="hero" className="relative h-[84vh] sm:h-[88vh] w-full overflow-hidden">
        ...
        {/* Work */}
        <section data-section="work" id="work" className="py-20 sm:py-28">
        ...
        {/* Skills */}
        <section data-section="skills" id="skills" className="py-20 sm:py-28 bg-gray-50">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <SectionHeader
              kicker="Expertise"
        ...
        {/* Contact */}
        <section data-section="contact" id="contact" className="py-20 sm:py-28">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <SectionHeader
              kicker="Contact"
